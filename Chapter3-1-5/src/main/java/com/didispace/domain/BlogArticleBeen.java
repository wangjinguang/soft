...
public class BlogArticleBeen {
	...
	public String toString() {
		return "BlogArticleBeen [id=" + id + ", name=" + name + ", mainPhoto=" + mainPhoto + ", sketch=" + sketch
				+ ", content=" + content + ", contentMd=" + contentMd + ", ifTop=" + ifTop + ", sources=" + sources
				+ ", staticCode=" + staticCode + ", status=" + status + ", creater=" + creater + ", columnNamesCache="
				+ columnNamesCache + ", columnIdsCache=" + columnIdsCache + ", labelIdsCache=" + labelIdsCache
